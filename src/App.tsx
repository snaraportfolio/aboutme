...
const PROJECTS: Project[] = [
  {
    ...
    years: "2023 - Present",
    shortName: "AGENTIC",
    oneSentenceImpact: "Strategized the integration of autonomous agent pilots into secure, high-compliance enterprise blueprints.",
    role: "Principal PM, AI Strategy",
    context: "Post-LLM explosion, the enterprise needed a roadmap for autonomous agents that didn't compromise security.",
    problem: "Scattered, uncoordinated AI experiments were creating security risks and tech debt.",
    decision: "Decided to halt non-compliant pilots and draft the 'Strategy in Motion' governance framework first.",
    outcome: "Standardized 5 pilot programs onto a secure, compliant base, reducing security audit time by 40%.",
  ...
  {
    title: "Product Creation & Consumer Services",
    years: "2021 - 2023",
    shortName: "INNOVATION",
    oneSentenceImpact: "Spearheaded specialized physiological data visualizations to drive measurable innovation in biomechanical design.",
    role: "Principal Product Manager",
    context: "Biomechanics data was trapped in silos, unusable for real-time product design iterations.",
    problem: "Designers were making decisions based on static reports instead of dynamic physiological body maps.",
    decision: "I synthesized a new technical strategy for physiological 'body maps', moving from static PDF reports to interactive data viz.",
    outcome: "Achieved a 180% engagement lift from design teams and a 30% increase in member activation for data-informed products.",
